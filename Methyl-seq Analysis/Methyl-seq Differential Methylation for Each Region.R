...
region_disorder_chr = paste(region, disorder, paste0("chr", chr.num), sep = "_")
...
res_dir = "res_dir"
save(dml.results, file = paste0(res_dir, "DSS_Filtered_NoSmooth_Ancestry_Prop_Results_", region_disorder_chr, ".Rdata"))
